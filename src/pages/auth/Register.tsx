...
import { User, Mail, KeyRound, AlertCircle, CheckCircle2, ArrowLeft, Loader2, Send } from 'lucide-react';
...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Falha ao solicitar cadastro');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="bg-white/[0.03] backdrop-blur-2xl p-10 rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden">
          ...
          <AnimatePresence mode="wait">
            {!success ? (
              ...
              >
                <div className="mb-10">
                  <h2 className="text-4xl font-noto-serif font-bold text-white tracking-tight">
                    Solicitar Acesso
                  </h2>
                  <p className="mt-4 text-gray-400 font-light leading-relaxed">
                    Faça parte do projeto de preservação da memória da nossa família. 
              ...
              >
                ...
                <p className="text-gray-400 leading-relaxed mb-8">
                  Obrigado, {name.split(' ')[0]}! Suas informações foram enviadas. 
                  Você receberá um e-mail assim que o administrador aprovar seu acesso.
                </p>
